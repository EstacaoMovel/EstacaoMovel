...
public class Notificacao implements Serializable {
    ...
    public Notificacao(int autocarroID, String nome, String origem, String destino, String hora_p, String horaC, Boolean notificacao, Boolean ativo) {
        ...
        this.ativo = ativo;
        notifImage = new ImageView();
        if (!this.notificacao) {
            notifImage = ImageManager.getImageView(UtilsUI.filenameClosed,20);
        }else{
            notifImage = ImageManager.getImageView(UtilsUI.filenameOpen,20);
    ...
    public void setNotifImage(ImageView notifImage) {
        this.notifImage = notifImage;
    }
    public void refreshNotificacao() {
        if (this.notificacao) {
            notifImage = ImageManager.getImageView(UtilsUI.filenameClosed,20);
        }else{
            notifImage = ImageManager.getImageView(UtilsUI.filenameOpen,20);
